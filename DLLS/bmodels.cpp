...
Vector VecBModelOrigin (entvars_t* pevBModel)
	...
	// »з-за функции SetObjectCollisionBox, внос€щей дефект в absmin и absmax, будем пересчитывать это значение
...
class CFuncRotating : public CBaseEntity
	...
	public:
		...
		float m_pitch;
		int	 m_sounds;
		int	 isSpinningUpOrRunning;	// ѕоле исправл€ет баг, при котором, если сохранение выполнено в момент неполной
		// остановки, при загрузке из сохранени€ поведение func_rotating мен€етс€ на разгон
	};
