...
void CSquidSpit :: Touch (CBaseEntity *pOther)
	...
	switch (RANDOM_LONG (0, 1))
		{
		case 0: EMIT_SOUND_DYN (ENT(pev), CHAN_WEAPON, "bullchicken/bc_spithit1.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
		case 1: EMIT_SOUND_DYN (ENT(pev), CHAN_WEAPON, "bullchicken/bc_spithit2.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
		}
...
BOOL CBullsquid :: CheckMeleeAttack2 (float flDot, float flDist)
	...
	if (flDist <= 85 && flDot >= 0.7 && !HasConditions (bits_COND_CAN_MELEE_ATTACK1))		// The player & bullsquid can be as much as their bboxes 
		return TRUE;										// apart (48 * sqrt(3)) and he can still attack (85 is a little more than 48*sqrt(3))
...
void CBullsquid :: IdleSound (void)
	...
	switch (RANDOM_LONG(0,4))
		{
		case 0:	EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_idle1.wav", 1, SQUID_ATTN_SMALL);	break;
		case 1:	EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_idle2.wav", 1, SQUID_ATTN_SMALL);	break;
		case 2:	EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_idle3.wav", 1, SQUID_ATTN_SMALL);	break;
		case 3:	EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_idle4.wav", 1, SQUID_ATTN_SMALL);	break;
		case 4:	EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_idle5.wav", 1, SQUID_ATTN_SMALL);	break;
		}
	}
...
void CBullsquid :: PainSound (void)
	...
	switch (RANDOM_LONG(0,3))
		{
		case 0:	EMIT_SOUND_DYN (ENT(pev), CHAN_VOICE, "bullchicken/bc_pain1.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
		case 1:	EMIT_SOUND_DYN (ENT(pev), CHAN_VOICE, "bullchicken/bc_pain2.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
		case 2:	EMIT_SOUND_DYN (ENT(pev), CHAN_VOICE, "bullchicken/bc_pain3.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
		case 3:	EMIT_SOUND_DYN (ENT(pev), CHAN_VOICE, "bullchicken/bc_pain4.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
		}
	}
...
void CBullsquid :: AlertSound (void)
	...
	switch (RANDOM_LONG (0, 1))
		{
		case 0: EMIT_SOUND_DYN (ENT(pev), CHAN_VOICE, "bullchicken/bc_idle1.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
		case 1: EMIT_SOUND_DYN (ENT(pev), CHAN_VOICE, "bullchicken/bc_idle2.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
		}
	}
	...
	case BSQUID_AE_THROW:
		...
		if (pHurt)
			...
			switch (RANDOM_LONG (0, 2))
				{
				case 0: EMIT_SOUND_DYN (ENT(pev), CHAN_WEAPON, "bullchicken/bc_bite1.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
				case 1: EMIT_SOUND_DYN (ENT(pev), CHAN_WEAPON, "bullchicken/bc_bite2.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
				case 2: EMIT_SOUND_DYN (ENT(pev), CHAN_WEAPON, "bullchicken/bc_bite3.wav", 1, ATTN_MEDIUM, 0, iPitch); break;
				}
...
void CBullsquid :: DeathSound (void)
	...
	switch (RANDOM_LONG (0, 2))
		{
		case 0: EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_die1.wav", 1, ATTN_MEDIUM); break;
		case 1: EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_die2.wav", 1, ATTN_MEDIUM); break;
		case 2: EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_die3.wav", 1, ATTN_MEDIUM); break;
		}
	}
...
void CBullsquid :: AttackSound (void)
	...
	switch (RANDOM_LONG (0, 2))
		{
		case 0: EMIT_SOUND (ENT(pev), CHAN_WEAPON, "bullchicken/bc_attack1.wav", 1, ATTN_MEDIUM); break;
		case 1: EMIT_SOUND (ENT(pev), CHAN_WEAPON, "bullchicken/bc_attack2.wav", 1, ATTN_MEDIUM); break;
		case 2: EMIT_SOUND (ENT(pev), CHAN_WEAPON, "bullchicken/bc_attack3.wav", 1, ATTN_MEDIUM); break;
		}
	}
...
void CBullsquid :: StartTask (Task_t *pTask)
	...
	case TASK_MELEE_ATTACK2:
		...
		switch (RANDOM_LONG (0, 2))
			{
			case 0: EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_attackgrowl1.wav", 1, ATTN_MEDIUM); break;
			case 1: EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_attackgrowl2.wav", 1, ATTN_MEDIUM); break;
			case 2: EMIT_SOUND (ENT(pev), CHAN_VOICE, "bullchicken/bc_attackgrowl3.wav", 1, ATTN_MEDIUM); break;
			}
