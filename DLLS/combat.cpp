...
BOOL CBaseMonster :: HasHumanGibs (void)
	...
	if (myClass == CLASS_HUMAN_MILITARY ||
		...
		myClass == CLASS_HUMAN_ASSASSIN ||	// Новый класс для Human assassin
...
void CGib :: Spawn (const char *szGibModel)
	...
	pev->solid = SOLID_TRIGGER;		// Устраняет бесконечное прыгание гибсов, хотя остальные последствия неизвестны
