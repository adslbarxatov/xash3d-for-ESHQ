...
// IdleSound
//=========================================================
#define CRAB_ATTN_SMALL (float)1.5
...
void CHeadCrab::AlertSound (void)
	{
	EMIT_SOUND_DYN (edict (), CHAN_VOICE, RANDOM_SOUND_ARRAY (pAlertSounds), GetSoundVolue (), ATTN_SMALL, 
		0, GetVoicePitch ());
	}
...
void CHeadCrab::DeathSound (void)
	{
	EMIT_SOUND_DYN (edict (), CHAN_VOICE, RANDOM_SOUND_ARRAY (pDeathSounds), GetSoundVolue (), ATTN_SMALL, 0, 
		GetVoicePitch ());
	}
