...
void CDeadScientist :: Spawn( )
{
	...
	pev->health			= 20;//gSkillData.scientistHealth;
...
char *CBurnedScientist::m_szPoses[] = { "lying_on_back", "lying_on_stomach", "dead_sitting", "dead_hang", "dead_table1", "dead_table2", "dead_table3" };
...
void CBurnedScientist :: Spawn( )
{
	...
	pev->body = 4;	// Обгоревший скин
	pev->skin = 0;	// Руки не изменяются
