...
void W_Precache (void)
	...
	PRECACHE_SOUND ("weapons/concrete_hit1.wav");	// Попадание в бетон
...
TYPEDESCRIPTION	CBasePlayerWeapon::m_SaveData[] = 
	...
	//DEFINE_FIELD (CBasePlayerWeapon, m_flPrevPrimaryAttack, FIELD_FLOAT),
	//DEFINE_FIELD (CBasePlayerWeapon, m_flLastFireTime, FIELD_FLOAT),
#else	// CLIENT_WEAPONS
	DEFINE_FIELD (CBasePlayerWeapon, m_flNextPrimaryAttack, FIELD_TIME),
	DEFINE_FIELD (CBasePlayerWeapon, m_flNextSecondaryAttack, FIELD_TIME),
	DEFINE_FIELD (CBasePlayerWeapon, m_flTimeWeaponIdle, FIELD_TIME),
	//DEFINE_FIELD (CBasePlayerWeapon, m_flPrevPrimaryAttack, FIELD_TIME),
	//DEFINE_FIELD (CBasePlayerWeapon, m_flLastFireTime, FIELD_TIME),
