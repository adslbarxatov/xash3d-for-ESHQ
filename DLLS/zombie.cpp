...
LINK_ENTITY_TO_CLASS (monster_zombie2, CZombie);		// ׁמגלוסעטלמסעü ס AOMDC
...
void CZombie :: PainSound (void)
	...
	if (RANDOM_LONG (0,5) < 2)
		EMIT_SOUND_DYN (ENT (pev), CHAN_VOICE, pPainSounds[ RANDOM_LONG (0,HLARRAYSIZE (pPainSounds)-1) ], 1.0, ATTN_SMALL, 0, pitch);
	}
...
void CZombie :: AlertSound (void)
	...
	EMIT_SOUND_DYN (ENT (pev), CHAN_VOICE, pAlertSounds[ RANDOM_LONG (0,HLARRAYSIZE (pAlertSounds)-1) ], 1.0, ATTN_SMALL, 0, pitch);
	}
...
void CZombie :: IdleSound (void)
	...
	EMIT_SOUND_DYN (ENT (pev), CHAN_VOICE, pIdleSounds[ RANDOM_LONG (0,HLARRAYSIZE (pIdleSounds)-1) ], 1.0, ATTN_SMALL, 0, 100 + RANDOM_LONG (-5,5));
	}

void CZombie :: AttackSound (void)
	{
	// Play a random attack sound
	EMIT_SOUND_DYN (ENT (pev), CHAN_VOICE, pAttackSounds[ RANDOM_LONG (0,HLARRAYSIZE (pAttackSounds)-1) ], 1.0, ATTN_SMALL, 0, 100 + RANDOM_LONG (-5,5));
	}
...
void CZombie :: HandleAnimEvent (MonsterEvent_t *pEvent)
	...
	case ZOMBIE_AE_ATTACK_RIGHT:
		...
		if (pHurt)
			...
			EMIT_SOUND_DYN (ENT (pev), CHAN_WEAPON, pAttackHitSounds[ RANDOM_LONG (0,HLARRAYSIZE (pAttackHitSounds)-1) ], 1.0, ATTN_SMALL, 0, 100 + RANDOM_LONG (-5,5));
			}
		else // Play a random attack miss sound
			EMIT_SOUND_DYN (ENT (pev), CHAN_WEAPON, pAttackMissSounds[ RANDOM_LONG (0,HLARRAYSIZE (pAttackMissSounds)-1) ], 1.0, ATTN_SMALL, 0, 100 + RANDOM_LONG (-5,5));
...
class CDeadZombie : public CBaseMonster
	...
	public:
		void Spawn (void);
		int	Classify (void) { return	CLASS_HUMAN_ASSASSIN;}	//CLASS_ALIEN_MONSTER; }
