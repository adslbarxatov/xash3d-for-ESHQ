...
#define PRC_DLY5	{PRC_DLY,	{ DLY_LOWPASS,	500.0,	0.5,	0.6,	FLT_LP,	1000,	1000,	QUA_LO, }, PFNZERO } // outside L
...
#define PRC_RVA2	{PRC_RVA,	{1.0,	0.2,	1.5,	FLT_LP,	0,		0,		0},	PFNZERO }

#define PRC_RVA3	{PRC_RVA,	{0.6,	0.3,	1.5,	FLT_LP,	2500,	2000,	0},	PFNZERO }	// metallic S
#define PRC_RVA4	{PRC_RVA,	{0.8,	0.3,	1.5,	FLT_LP,	2500,	2000,	0},	PFNZERO }	// metallic M
#define PRC_RVA5	{PRC_RVA,	{1.0,	0.3,	1.5,	FLT_LP,	2500,	2000,	0},	PFNZERO }	// metallic L
...
#define PRC_RVA12	{PRC_RVA,	{1.0,	0.5,	1.5,	FLT_LP,	6000,	2000,	1},	PFNZERO }	// chamber S
#define PRC_RVA13	{PRC_RVA,	{1.0,	1.0,	1.5,	FLT_LP,	6000,	2000,	1},	PFNZERO }	// chamber M
#define PRC_RVA14	{PRC_RVA,	{1.0,	1.5,	1.5,	FLT_LP,	6000,	2000,	1},	PFNZERO }	// chamber L
...
#define PRC_RVA19	{PRC_RVA,	{0.8,	1.0,	1.25,	FLT_LP,	4000,	2000,	1},	PFNZERO }	// concrete S
#define PRC_RVA20	{PRC_RVA,	{1.3,	1.4,	1.5,	FLT_LP,	3500,	2000,	1},	PFNZERO }	// concrete M
#define PRC_RVA21	{PRC_RVA,	{1.8,	1.8,	1.75,	FLT_LP,	3000,	2000,	1},	PFNZERO }	// concrete L
...
/*{PSET_LINEAR,	2, { PRC_DFR1,	PRC_RVA3,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // METALIC_S	2	// highly reflective, parallel surfaces 
{PSET_LINEAR,	2, { PRC_DFR1,	PRC_RVA4,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // METALIC_M	3
{PSET_LINEAR,	2, { PRC_DFR1,	PRC_RVA5,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // METALIC_L	4
...
{PSET_SIMPLE,	1, { PRC_RVA3,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // METALIC_S	2
{PSET_SIMPLE,	1, { PRC_RVA4,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // METALIC_M	3
{PSET_SIMPLE,	1, { PRC_RVA5,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // METALIC_L	4
{PSET_SIMPLE,	1, { PRC_RVA6,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},2.0, WZERO }, // TUNNEL_S	5
{PSET_SIMPLE,	1, { PRC_RVA7,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.8, WZERO }, // TUNNEL_M	6
{PSET_SIMPLE,	1, { PRC_RVA8,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // TUNNEL_L	7
{PSET_SIMPLE,	1, { PRC_RVA12,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // CHAMBER_S	8
{PSET_SIMPLE,	1, { PRC_RVA13,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // CHAMBER_M	9
{PSET_SIMPLE,	1, { PRC_RVA14,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.9, WZERO }, // CHAMBER_L	10

{PSET_SIMPLE,	1, { PRC_RVA15,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.5, WZERO }, // BRITE_S	11
...
{PSET_SIMPLE,	1, { PRC_RVA19,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.7, WZERO }, // CONCRTE_S	17
{PSET_SIMPLE,	1, { PRC_RVA20,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.8, WZERO }, // CONCRTE_M	18
{PSET_SIMPLE,	1, { PRC_RVA21,	PRC0,	PRC0,	PRC0,	PRC0,	PRC0	},1.9, WZERO }, // CONCRTE_L	19
...
{PSET_LINEAR,	2, { PRC_DFR1,	PRC_DLY5,	PRC0,	PRC0,	PRC0,	PRC0	},1.8, WZERO }, // OUTSIDE3	22	// echoing, very dull
